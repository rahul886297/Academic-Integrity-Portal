      ...
      <div style={styles.leftSection}>
        <div style={styles.logoWrapper}>
          <div style={styles.logoMarkWrapper}>
            ...
            <h1 style={styles.logoText}>UPES</h1>
          </div>
          <div style={styles.logoSubtextContainer}>
            <span style={styles.logoSubtext}>UNIVERSITY OF TOMORROW</span>
          </div>
        </div>
      </div>
        ...
        <div style={styles.loginCard}>
          <div style={styles.cardHeader}>
            <div style={styles.smallLogo}>
               ...
               <span style={styles.smallLogoText}>UPES</span>
            </div>
            <p style={{ fontSize: '12px', margin: '-5px 0 15px 0', opacity: 0.8 }}>UNIVERSITY OF TOMORROW</p>
            <h2 style={styles.welcomeText}>Welcome to MyUPES</h2>
          </div>
